...
export interface GetRegisteredOrdersRequest {
}

export interface GetRegisteredOrdersResponse {
  orders: Order[];
  error?: Error | undefined;
}
...
export interface OrdersServiceClient {
  ...
  getRegisteredOrders(request: GetRegisteredOrdersRequest): Observable<GetRegisteredOrdersResponse>;
}
...
export interface OrdersServiceController {
  ...
  getRegisteredOrders(
    request: GetRegisteredOrdersRequest,
  ): Promise<GetRegisteredOrdersResponse> | Observable<GetRegisteredOrdersResponse> | GetRegisteredOrdersResponse;
}

export function OrdersServiceControllerMethods() {
  return function (constructor: Function) {
    const grpcMethods: string[] = ["createOrders", "getAllOrders", "getOrder", "updateOrder", "getRegisteredOrders"];
